...
if __name__ == "__main__":
    ...
    create_dir("G:/files/masks")
    

    """ Loading model """
    model = tf.keras.models.load_model("G:/files/model/model.h5")

    """ Load the dataset """
    data_x = glob("F:\\test\\images\\*")
    ...
    for path in tqdm(data_x, total=len(data_x)):
        ...
        cv2.imwrite(f"G:/files/masks/{name}.png", cat_images)
